...
public class CourseRepositoryForFilterImpl implements CourseRepositoryForFilter {
    ...
    public Page<Course> filterCourse(FilterCourseRequest filter, Pageable pageable) {
        ...
        if (filter.getCreditFrom() != null && filter.getCreditTo() != null) {
            if (filter.getCreditFrom() > filter.getCreditTo()) {
                throw new IllegalArgumentException(MessageResponse.CREDIT_FROM_GREATER_THAN_TO);
            }
        }
